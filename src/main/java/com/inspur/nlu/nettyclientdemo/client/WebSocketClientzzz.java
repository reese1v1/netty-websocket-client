...
import com.inspur.nlu.nettyclientdemo.handler.WebSocketClientHandlerzzz;
...
public class WebSocketClientzzz {
    ...
    public void connect(String URL, ChannelGroup clients, ChannelHandlerContext ctx) throws Exception {
        ...
        try {
            final WebSocketClientHandlerzzz handler = new WebSocketClientHandlerzzz(ctx, WebSocketClientHandshakerFactory
